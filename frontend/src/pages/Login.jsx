    ...
    <div className="min-h-screen flex text-foreground bg-background">
      ...
      <div className="hidden lg:flex w-1/2 bg-zinc-950 relative items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-lg animate-fade-in-up">
          ...
          <h1 className="text-5xl font-black mb-6 leading-tight">Welcome back to premium.</h1>
          <p className="text-lg text-zinc-300 font-light leading-relaxed">
            Sign in to access your curated collection, track orders, and discover the latest in state-of-the-art tech.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="mb-10 lg:mb-12">
            ...
            <p className="text-muted-foreground font-light text-sm">
              Don't have an account? <Link to="/signup" className="text-violet-600 dark:text-violet-400 font-semibold hover:underline">Create one</Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 flex flex-col">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="#" className="text-xs font-semibold text-violet-600 dark:text-violet-400 hover:underline">Forgot password?</Link>
              </div>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-14 text-lg font-bold mt-4 bg-violet-600 hover:bg-violet-700 text-white rounded-xl shadow-lg shadow-violet-600/20 transition-all hover:-translate-y-0.5"
            >
              {loading ? (
