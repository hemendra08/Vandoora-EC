      ...
      <div className="max-w-7xl mx-auto px-4 md:flex md:justify-between md:gap-8">
        ...
        <div className="mb-6 md:mb-0">
          ...
          <div className="flex space-x-4 mt-2 text-2xl">
            ...
            <a href="#" aria-label="Pinterest" className="hover:text-pink-500">
              <FaPinterest />
            </a>
          </div>
        </div>
        ...
        <div className="mb-6 md:mb-0 w-full md:w-80">
          ...
          <form className="mt-4 flex" onSubmit={(e) => e.preventDefault()}>
            <input
              ...
              required
              className="w-full p-2 rounded-l-md bg-white text-black focus:outline-none focus:ring-2 focus:ring-gray-500"
            />
            <button
              type="submit"
